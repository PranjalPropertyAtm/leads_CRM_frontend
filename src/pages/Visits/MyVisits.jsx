...
export default function MyVisits() {
  ...
  const filtered = visits.filter((visit) => {
    ...
    const name =
      visit?.lead?.customerName?.toLowerCase?.() ||
      visit?.lead?.ownerName?.toLowerCase?.() ||
      "";
  
    const location =
      visit?.lead?.customerType === "owner"
        ? visit?.lead?.propertyLocation?.toLowerCase?.() || ""
        : visit?.propertyLocation?.toLowerCase?.() || "";
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-11 pr-4 py-2.5 rounded-lg border border-gray-300 bg-white shadow-sm w-72
