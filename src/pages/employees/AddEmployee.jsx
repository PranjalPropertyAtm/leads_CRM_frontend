...
import { Users, Mail, Phone, Lock, Briefcase, AlertCircle, Eye, EyeOff } from "lucide-react";
...
export default function AddEmployee() {
  const [formData, setFormData] = useState({
    ...
    password: "",
    designation: "",
    role: "employee", // default to employee; admin can choose Admin / Customer Care / Employee
  });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-lg border ${errors.name ? "border-red-400" : "border-gray-300"
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-lg border ${errors.email ? "border-red-400" : "border-gray-300"
                    } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                />
                {errors.email && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
              ...
              <div>
                ...
                <input
                  ...
                  maxLength="10"
                  className={`w-full px-4 py-2.5 rounded-lg border ${errors.phone ? "border-red-400" : "border-gray-300"
                    } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                />
                {errors.phone && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-lg border ${errors.designation ? "border-red-400" : "border-gray-300"
                    } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                />
                {errors.designation && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
              ...
              <div className="md:col-span-2 relative">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-lg border ${errors.password ? "border-red-400" : "border-gray-300"
                    } focus:outline-none focus:ring-2 focus:ring-blue-500`}
                />
