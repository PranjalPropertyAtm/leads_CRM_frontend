...
//                     {[
//                       "S.NO", "Name", "Type", "Member Code", "Date", "Mobile", "City", "Property", "Source", "Registered", "Vists", " ",
//                     ].map((h) => (
...
//                                 setVisitLead(lead);
//                               }}
//                               className="w-full px-4 py-2 flex items-center gap-2 hover:bg-gray-100 text-blue-600"
//                             >
//                                Add Visit
//                             </button>
//                           {/* )} */}
