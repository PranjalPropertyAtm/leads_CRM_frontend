...
//                       <td className="px-4 py-3">
//                         <span
//                           className={`px-3 py-1 text-xs rounded-full ${lead.customerType === "tenant"
...
export default function AllLeads() {
  ...
  const {
    ...
    isError: empError,
    error: empErrorObj,
  } = useFetchEmployees(1, 1000); // B: employees route accessible to admin + employees
  ...
  const handleRegisterLead = async () => {
    ...
    const registeredById = regBy || user?.name;
                    ...
                    >
                      ...
                      <td className="px-5 py-4 text-right">
                        <ActionMenu>
                          ...
                          <button onClick={() => handleDelete(lead._id)} className="w-full flex items-center gap-2 px-4 py-2 hover:bg-gray-100 text-sm text-red-600 transition">
                            <Trash2 size={14} /> Delete
                          </button>
                        </ActionMenu>
                      </td>
              ...
              <div>
                ...
                {selected?.isRegistered ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <InfoRow label="Registered By" value={selected.registrationDetails?.registeredBy?.name ||  "N/A"} />
                  </div>
                ) : (
